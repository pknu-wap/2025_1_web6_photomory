...
import AddGroupButtonTest from "./AddGroupButtonTest";
import SelectGroupOptionsTest from "./SelectGroupOptionsTest";
  ...
  return (
    <div className="currentGroupCard">
      ...
      <div style={{ display: "flex", gap: "16px" }}>
        {/* 그룹선택 옵션*/}
        <SelectGroupOptionsTest
          groupList={groupList}
          onSelect={handleChange} //그룹 선택 핸들러
        />

        {/*그룹추가버튼 컴포넌트*/}
        <AddGroupButtonTest onAddGroup={onAddGroup} />
      </div>
    </div>
  );
}
